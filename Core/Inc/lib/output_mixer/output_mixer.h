...
#define PID_ROLL_PITCH_KP  2.0f
#define PID_ROLL_PITCH_KI  0.5f
#define PID_ROLL_PITCH_KD  0.25f

#define PID_ROLL_PITCH_LIM_MIN -500.0f
#define PID_ROLL_PITCH_LIM_MAX  500.0f

#define PID_ROLL_PITCH_LIM_MIN_INT -5.0f
#define PID_ROLL_PITCH_LIM_MAX_INT  5.0f
